...
* API v1 read endpoints (runs/sessions/tasks) now query the database directly
  instead of routing through the run manager command channel ([#779](https://github.com/stjude-rust-labs/sprocket/pull/779)) .
