...
* CI now reads the Python version from `pyproject.toml` via `python-version-file` instead of hardcoding it in each job ([#972](https://github.com/stjude-rust-labs/sprocket/pull/977)).
