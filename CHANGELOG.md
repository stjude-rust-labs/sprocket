...
* Fixed `sprocket validate` to surface an error when File/Directory inputs
  including nested collections — reference paths that do not exist ([#455](https://github.com/stjude-rust-labs/sprocket/issues/455)).
