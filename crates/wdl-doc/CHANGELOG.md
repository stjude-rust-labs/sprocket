...
* "raw" workflow names get code formatting in the H1 header. Explicitly named workflow headers are unchanged ([#619](https://github.com/stjude-rust-labs/sprocket/pull/619)).
