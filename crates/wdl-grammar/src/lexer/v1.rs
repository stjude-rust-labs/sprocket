...
env"#,
        ...
        assert_eq!(
            ...
            &[
                ...
                (Ok(FromKeyword), 107..111),
                (Ok(Whitespace), 111..112),
                (Ok(IfKeyword), 112..114),
                (Ok(Whitespace), 114..115),
                (Ok(HintsKeyword), 115..120),
                (Ok(Whitespace), 120..121),
                (Ok(InKeyword), 121..123),
                (Ok(Whitespace), 123..124),
                (Ok(ImportKeyword), 124..130),
                (Ok(Whitespace), 130..131),
                (Ok(InputKeyword), 131..136),
                (Ok(Whitespace), 136..137),
                (Ok(MetaKeyword), 137..141),
                (Ok(Whitespace), 141..142),
                (Ok(NullKeyword), 142..146),
                (Ok(Whitespace), 146..147),
                (Ok(ObjectKeyword), 147..153),
                (Ok(Whitespace), 153..154),
                (Ok(OutputKeyword), 154..160),
                (Ok(Whitespace), 160..161),
                (Ok(ParameterMetaKeyword), 161..175),
                (Ok(Whitespace), 175..176),
                (Ok(RequirementsKeyword), 176..188),
                (Ok(Whitespace), 188..189),
                (Ok(RuntimeKeyword), 189..196),
                (Ok(Whitespace), 196..197),
                (Ok(ScatterKeyword), 197..204),
                (Ok(Whitespace), 204..205),
                (Ok(StructKeyword), 205..211),
                (Ok(Whitespace), 211..212),
                (Ok(TaskKeyword), 212..216),
                (Ok(Whitespace), 216..217),
                (Ok(ThenKeyword), 217..221),
                (Ok(Whitespace), 221..222),
                (Ok(TrueKeyword), 222..226),
                (Ok(Whitespace), 226..227),
                (Ok(VersionKeyword), 227..234),
                (Ok(Whitespace), 234..235),
                (Ok(WorkflowKeyword), 235..243),
                (Ok(Whitespace), 243..244),
                (Ok(EnvKeyword), 244..247),
            ],
        );
    }
