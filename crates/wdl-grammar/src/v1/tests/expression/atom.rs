...
fn it_successfully_parses_a_struct_literal_with_a_comma() {
    parses_to! {
        ...
        tokens: [
            struct_literal(0, 19, [
                struct_literal_name(0, 6, [
                    singular_identifier(0, 6),
                ]),
