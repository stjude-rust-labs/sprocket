...
* Removed some "formatting only" lint rules (CallInputSpacing, CommentWhitespace, EndingNewline, ImportSorted, ImportWhitespace, LineWidth, LintDirectiveFormatted, MetaKeyValueFormatting, PreambleCommentPlacement, PreambleFormatted, SectionOrdering, TrailingComma, VersionStatementFormatted, Whitespace) ([#614](https://github.com/stjude-rust-labs/sprocket/pull/614)) ([#665](https://github.com/stjude-rust-labs/sprocket/pull/665)) ([#679](https://github.com/stjude-rust-labs/sprocket/pull/679)).
