...
pub enum Tag {
    ...
    /// Rules associated with documentation generated by the Sprocket `doc`
    /// command.
    SprocketDoc,
}
...
impl std::str::FromStr for Tag {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            s if s.eq_ignore_ascii_case("sprocketdoc") => Ok(Self::SprocketDoc),
...
impl std::fmt::Display for Tag {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::SprocketDoc => write!(f, "SprocketDoc"),
        }
    }
}
